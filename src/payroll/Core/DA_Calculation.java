...
System.out.println("Hello.........vda_Calc_latest");
		   ...
		   int flag=0;
 			...
 			try
		 	{
		 		...
		 		System.out.println("mda1 :"+mda);
		 		
		 		//Step - 2
		 		mda = mda*cpiindex;
		 		System.out.println("mda2 :"+mda);
		 		
		 		//Step - 3
 				mda = mda - mban;
 				System.out.println("mda3 :"+mda);
		 		mdanew = mda;
		 		System.out.println("mdanew :"+mdanew);
		 		
		 		//Step - 4
 						//Step - 4(i)
 						mda = (mda*55/100);
 						System.out.println("mda4(i) :"+mda);
 						
 						//Step - 4(ii)
 						mda = (mda*fixbasic/100);
 						System.out.println("mda4(ii) :"+mda);
		 		*/
		 		...
		 		//Step - 5
 						...
 						while(all.next())
 						{
 							...
 							mbasic = basic-fixbasic;
 	 						System.out.println("mbasic :"+mbasic);
 	 						
 	 						
 	 					//Step - 5(i)
 							mdanew = (mdanew*20/100);
 							System.out.println("mdanew5(i) :"+mdanew);
 						
 							//Step - 5(ii)
 							mdanew = (mdanew*mbasic/100);
 							System.out.println("mdanew(ii) :"+mdanew);
		 		
 							//Step - 6
 							mdavalue = mda + mdanew;			
 							System.out.println("mdavalue6 :"+mdavalue);
 				 			...
 				 			for(DAGradeBean gBean: gradeList)
 				 			 {
 				 				...
 				 				try
 				 				{
 				 					...
 				 					System.out.println(" UPDATE DA_GRADE_MASTER SET DA="+mdavalue+",DA_TYPE=0,DA_VAL="+mdavalue+"  " +
 				 									" WHERE  SRNO="+srno+" AND GRADE_CODE="+gradeCode+"   " +
 				 									" AND START_DATE='"+gBean.getStartDate()+"'");
