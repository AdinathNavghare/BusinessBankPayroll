...
public class HeaderAndFooter_New extends PdfPageEventHelper {
    ...
    HeaderAndFooter_New (String lbl,String lbl2)
    {
    ...
    System.out.println("inside startpage");
		...
		PdfPTable main1 = new PdfPTable(23);
				main1.setSpacingBefore(20);
					...
					try {
						...
						main1.setWidthPercentage(new float[]{ 4, 9.0f, 
				...
				PdfPCell maincell23 = new PdfPCell(new Phrase("Extra Ded",fbold));
