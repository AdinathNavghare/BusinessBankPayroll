...
public class DAServlet  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("in calculateDA");
	  ...
	  /* if(!daApplicableDate.equals("01-Jan-2016")){
	   ...
	   {*/
		  // VDA_Calculation.vda_Calc_latest(daApplicableDate,"desig");
		   ...
		   System.out.println("..........EXECUTED SUCCESSFULY FOR GRADE wise  ....THIS IS NEWLY HURRRRRRRRRWYYYYYYYYYYYYY");
		   System.out.println("..........akshay 00000000 @123  ....THIS IS NEWLY HURRRRRRRRRWYYYYYYYYYYYYY");
	   
			//VDA_Calculation.vda_Calc_latest(daApplicableDate,"emp");
		   VDA_Calculation.vda_Calc_latest(daApplicableDate);
			System.out.println("..........EXECUTED SUCCESSFULY FOR EMPLOYEEWISE  ....THIS IS NEWLY HURRRRRRRRRWYYYYYYYYYYYYY");
			System.out.println("..........akshay 00000000 @123  6789 ....THIS IS NEWLY HURRRRRRRRRWYYYYYYYYYYYYY");
	  /* }	*/
			int flag=1;
