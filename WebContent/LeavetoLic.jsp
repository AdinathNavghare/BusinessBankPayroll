...
<%-- <%
String pageName = "LeavetoLic.jsp";
try
{
...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<form name="leavetolicForm" action="ReportServlet" method="post" onSubmit="  return validate()">
			<table border="1" id="customers">
				<tr><th> LEAVE To LIC Report</th>
				</tr>
				<tr class="alt">			
				<td height="120" align="center">
				<input type="hidden" id="action" name="action" value="leavetolic"></input>
