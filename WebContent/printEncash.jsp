...
<script type="text/javascript">
	...
	/* function TakeCustId() {
		...
		function validateEndDate(startDate,endDate){
			...
			var start = "01-"+document.getElementById("date").value;
			var end = "30-"+document.getElementById("todate").value;
			start = parseMyDate(start);
			end = parseMyDate(end);
			if (start > end) {
				alert("Select date should not be grater than TO date !");
	...
	function changeValid()
	{
		 ...
		 if((document.getElementById("Employee").value== "one"))
		{
			
			var result_style = document.getElementById('empnumberrow').style;
			
			var result_style2 = document.getElementById('branchrow').style;
			result_style.display = 'table-row';
			document.getElementById("EMPNO").focus();
			result_style2.display = 'none';
		}
		
		else if((document.getElementById("Employee").value== "branch"))
		{
		    var result_style = document.getElementById('empnumberrow').style;
		    var result_style2 = document.getElementById('branchrow').style;
			...
			<th rowspan="3" class="sized"><img src="images/shared/side_shadowright.jpg" width="20" height="300" alt="" /></th>
						...
						<tr>
							...
							<div id="content-table-inner">
								...
								<center>
							<form action="LeaveEncashServlet?action=printEncash" method="post"  onsubmit="return validation()">   
					 			 <table id="customers">
								<tr><th colspan="2" align="Center">Print Encashment Details </th></tr>
								<tr>
									<td>Select Date</td>
										<td bgcolor="#FFFFFF">
										<input  name="date" id="date" readonly="readonly" class="date-picker" onBlur="validateEndDate('date','todate')"  placeholder="Click here for Calender"/>

										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										To :
										&nbsp;&nbsp;&nbsp;&nbsp;
										<input  name="todate" id="todate" readonly="readonly" class="date-picker" onBlur="validateEndDate('date','todate')" placeholder="Click here for Calender"/>

										
										</td>
								</tr>
								<tr><td>Select Employee</td><td>
								<select class="form-control" name="Employee" id="Employee" onchange="changeValid()" >
									<option value="0">Select</option>
									<option value="one">One Employee</option>
									<option value="all">All Employees</option>
									<option value="branch">BRANCH Employee</option> 
								</select></td></tr>
								...
								<tr id="branchrow" style="display:none;">
										...
										<td>
											...
											<select class="form-control" name="prjemp" id="prjemp">
								...
								<tr id="empnumberrow" style="display:none;">
									<td>Employee Number : </td><td><input type="text" class="form-control" name="EMPNO" id="EMPNO" size="40" value=""></td>
								</tr>
								
									
										
										
								<tr><td colspan="2" align="center"><input type="submit" class="myButton" value="Print"></td></tr>
