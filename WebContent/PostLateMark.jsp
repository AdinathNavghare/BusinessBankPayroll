...
<title>LateMarking &copy DTS3</title>
...
/* 	if (document.getElementById("deduction").value == "0") {
	...
	var check=confirm("Are you sure to post?");
	if(check)
	{
	if(numList != "")
	{
	...
	//	var deduction=document.getElementById("deduction").value;
			...
			url="lateMarkingServlet?action=Add&list="+numList+"&date="+date;
				   ...
				   <tr> <th>Post Late Mark</th></tr>
					 ...
					 <tr class="alt" align="center">
						<td >
							...
							<input type="button" class="myButton" value="Select Employees" onclick="getFilt('lateMarkPost')">
					...
					<tr class="alt">
						<td  align="center"> 
							<input type="button" class="myButton" value="Post " onclick="paycal()"/> &nbsp;&nbsp;
