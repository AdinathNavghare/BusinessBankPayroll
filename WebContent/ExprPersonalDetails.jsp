			...
			/* 	var xmlhttp1=new XMLHttpRequest();
		  		  ...
		  		  //alert(ProjectId);
		  		      xmlhttp1.onreadystatechange=function()
					  	...
					  	html +='<tr id="h1"><td width="98" align="center"></td><td>'+response3[0]+'</td><td>'+response3[1]+'</td><td>'+response3[2]+'</td><td>'+response3[3]+'</td><td>'+response3[4]+'</td></tr>';
					  	
					  $('.form_data3').html(html);
		  
		  		          }
		  		    	  
		  		    	 
		  		        }
		  		      xmlhttp1.open("POST","ExprInterviewServlet?action=DisplayPersonalInfo",true);
...
<div id="content"  >
	...
	<div id="content" align="center"  ><!--  start page-heading -->
			...
			<div class="step-no"><a href="ExprPersonalDetails.jsp" style="color: white;">1</a></div>
			<div class="step-dark-left"><a href="ExprPersonalDetails.jsp" >PersonalDetail</a></div>
...
%>		
     ...
     <input type="hidden" name="exprid" id="exprid" value="<%=exprid%>">
		<div>
			...
			<tr class="alt">
				<td colspan="8" style="text-align: right;">Current Date <font  color="red">*</font>: <input type="text" id="txtDate1" value="<%=rs.getCrrDate() %>" name="crrDate" class='datepick' readonly="readonly" style="position:relative; "></td>
					
			</tr>
					<tr class="alt">
					 <td style="text-align: center;">Full Name (Surname First)<font  color="red">*</font>:</td>
					  <td colspan="3"><input type="text" name="pname" value="<%=rs.getPName()%>" id="pname"></td>
					</tr>
					
					<tr class="alt">
					 <td style="text-align: center;">Date of Birth<font  color="red">*</font>:</td>
					  <td><input type="text" id="txtDate" name="dob" value="<%=rs.getDOB() %>" class='datepick' readonly="readonly" style="position:relative; "></td>
					 <td style="text-align: center;">Email ID<font  color="red">*</font>:</td>
					...
					<td style="text-align: center;">Marital Status</td>
					 ...
					 <td style="text-align: center;">Hand phone No.<font  color="red">*</font>:</td>                                              
   ...
   <div id="addPersonal">
     <form action="#" method="Post">
		<div id="div1">
			...
			<tr class="alt">
				<td colspan="8" style="text-align: right;">Current Date <font  color="red">*</font>: <input type="text" id="txtDate1" name="crrDate" class='datepick' readonly="readonly" style="position:relative; "></td>
					...
					<tr class="alt">
					 <td style="text-align: center;">Date of Birth<font  color="red">*</font>:</td>
					  <td><input type="text" id="txtDate" name="dob" class='datepick' readonly="readonly" style="position:relative; "></td>
					 <td style="text-align: center;">Email ID<font  color="red">*</font>:</td>
