	...
	//   alert(document.getElementById("prjCode1").value);
	   ...
	   {			
			 ...
			 //   alert(date);
		        ...
		        date="01-Jan-"+date;
				url="LeaveEncashServlet?action=leaveEncashReport&date="+date+"&prjCode1="+prjCode1;
...
<div id="content-outer" style="overflow-y: scroll; max-height: 78%;">
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
		...
		<tr>
			...
			<center>
			<!-- This is for Encash Report strat from here -->	
			<!-- 	<form action="LeaveEncashServlet?action=leaveEncashReport" method="post" onsubmit="">	 -->			
						<!-- <input type="submit" id="takeReport" name ="takeReport"  onclick="paycal()" value="TakeReport"  /> -->
			<!-- 	</form> -->
			<!-- Encash Report End here -->	
			<div>
				<center>
	     	...
	     	<td>
		     			<input type="submit" class="myButton" id="tentativeReport" name ="tentativeReport"  onclick="Leavetentative()" value="Click Here for Next Year Leave Encashment List"/>
		     		</td>
		     	</tr>	
				</table>
				</center>	
			...
			<div id="">
				...
				<tr>
		     	...
		     	<option value="" selected>Select</option>	
		     			...
		     			<td  align="center">Branch Code :</td>
								<td>
								 <select style="width:300px" name="prjCode1" id="prjCode1" >
										...
										<%
    										ArrayList<EmpOffBean> listt= new ArrayList<EmpOffBean>();
											EmpOffHandler ofhh = new EmpOffHandler();
    						 				listt=ofhh.getprojectCode();
    						 				int pp;
    						 				if(prjCode==""||prjCode==null){
    						 					pp=0;
    						 				}else{
    						 					pp= Integer.parseInt(prjCode);
    						 				}
    						 				for(EmpOffBean lkb :listt)
    						 				{    						 											
    						 					if (pp == lkb.getPrj_srno())  {
    						 			%>
		     		...
		     		<td>
		     			<input type="submit" class="myButton" id="takeReport" name ="takeReport"  onclick="paycal()" value="Take Report"  />
		     		</td>
		     	</tr>	
				</table>
				</center>	
