...
<script>
	...
	function ViewReport() 
	{
		...
		url="SalnetServlet?action=SequenceFile&reportType="+reportType+"&date="+date;
...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<input type="hidden" id="action" name="action" value="SequenceFile"></input>
				<table border="1" id="customers">
					<tr>
						<th colspan="5">SALNET Report</th>
					</tr>
					 <tr class="alt">
					      ...
					      <tr class="alt">
							<td>Select Report </td>
							<td>
								<select class="form-control" name="reportType" id="reportType" style="width:140px">  
