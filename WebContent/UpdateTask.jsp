...
<%-- 	<%@include file="subHeader.jsp" %> --%>
	...
	<form action="AddTaskServlet?action=updatetask" method="post" onsubmit="return TaskValidation()">
		...
		<table id="customers" align="center">
			...
			<tr class="alt"><%-- <td>Project Name :</td>
			   ...
			   <td colspan="3"><input type="text" id="name" name="name" value="<%=name%>" style="width:600px; height: 25px ";></td>
			</tr>

           <tr class="alt"><td>Type :</td>
				<td>
					<select id="typeid" name="type" value="<%=type%>" style="width:155px";>
          ...
          <tr class="alt"><td>Priority :</td>
				<td>
				      <select id="priority" name="priority" value="<%=priority%>" style="width:155px";>
