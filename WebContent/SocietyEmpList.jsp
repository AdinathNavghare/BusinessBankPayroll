...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<form name="SocietyDeductionForm" action="ReportServlet" onSubmit="  return validate()">
			<table border="1" id="customers">
				<tr><th> Employees PF List</th>
				</tr>
				<tr class="alt">			
				<td height="120" align="center">
				<input type="hidden" id="action" name="action" value="societyEmpList"></input>
