		...
		<center>
			<form  name="esicchallanform" action="ReportServlet?action=esicchallan" method="post" onsubmit="return validate()">
				<table id="customers" width="553" align="center">
				   ...
				   <tr class="alt">
				   <td colspan="2" align="center"> <input type="submit" class="myButton" id='before' name='before' value="Before Finalize"/> </td>
				   <td colspan="2" align="center"> <input type="submit" class="myButton" id='after' name='after' value="After Finalize"/> </td>
