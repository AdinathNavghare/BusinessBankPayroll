...
else
{
	...
	function ViewReport1()
	{
		...
		if(txt)
		{
		  ...
		  // url="ReportServlet?action=newpayreg&date="+date+"&typ="+typ+"&frmt="+format+"&reptype="+reporttype;
		   //  url="ReportServlet?action=newpayreg&date="+date+"&typ="+typ+"&frmt="+format+"&reptype="+reporttype+"&emptype="+employeetype;
		   	//   url="ReportServlet?action=newpayreg&date="+date+"&typ="+typ+"&frmt="+format+"&reptype="+reporttype+"&emptype="+employeetype+"&branch="+branchcode;
		   	    url="ReportServlet?action=sequentialFile_Branches&date="+date+"&typ="+typ+"&frmt="+format+"&reptype="+reporttype+"&emptype="+employeetype+"&branch="+branchcode;  
...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Sequential File Branches</h1>
	</div>
	<!-- end page-heading -->
     			      			...
     			      			<select name="emptype" id="emptype" >  
      					 			<option value="0">Select</option>  
			    						<%
			     					 	  ...
			     					 	  <%}%>
			     					 	  <option value="4">NON PERMANANT</option>
