...
{
	var transactioncode = document.getElementById("trncd").value;
	...
	{
		format="xls";
	    url="ReportServlet?action=salaryCodeWiseReg&date="+date+"&frmt="+format+"&transactioncode="+transactioncode;
	}
	else
	{
	    url="ReportServlet?action=salaryCodeWiseReg&date="+date+"&frmt="+format+"&transactioncode="+transactioncode;
...
<body style="overflow:hidden;"> 
 <%
	String pageName = "SalaryCodeWiseReg.jsp";
	try
	{
...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Salary Code Wise Register </h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<table border="1" id="customers">
					...
					<tr class="alt">
     				...
     				<td align="center" colspan="4"><b>Salary Code :</b>
					...
					<%
    					...
    					getresult = cmd.SalaryCodeListReport();
     				...
     				%>
     				<option value="LOANEMI">ALL LOAN EMI</option>
						</select>
					</td>
				      		
     			      		
					<td><input type="radio" name="format" id="Excel" value="Excel" checked>&nbsp;&nbsp;Excel&nbsp;</td>	
						<td align="center"><input type="submit"	value="GET REPORT" onclick="ViewReport1()"/></td>
						</tr>
