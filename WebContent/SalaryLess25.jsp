...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Salary Less Than 25% Report</h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<form name="lesssalrpt" action="ReportServlet" method ="post"  >
			<table border="1" id="customers" align="center">
			<tr>
				<th>Less Salary Report</th>
			<tr>
			<tr class="alt">
				<td  align="center">
			...
			<!-- <tr class="alt" height="30" align="center">
					...
					<td>Select Employee</td>
					 <td align="left">
					<input name="EMPNO" id="EMPNO"  placeholder="Enter All For All Employee"/>
					</td> 
				</tr> -->
				
				<tr class="alt" height="30" align="center">
                	<input type="hidden" id="action" name="action" value="lesssalary25report"></input>
