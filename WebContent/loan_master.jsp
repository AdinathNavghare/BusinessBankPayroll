...
<body style="overflow: hidden;" onLoad="checkFlag()">
 ...
 %>
										...
										<tr>
											<td align="right" bgcolor="#1F5FA7">&nbsp;</td>
										</tr>
											...
											<td>
												...
												<h3>
													...
													<input align="right" type="button" value="Loan Calculator"
														onclick="loancal()" class="myButton" />
												</h3>
 ...
 %>
										...
										%>
										<tr>
											<td align="left" bgcolor="#1F5FA7"><input type="button"
														...
														<table id="customers">
															...
															<tr>
																...
																<td><input size="14" name="startDate"
																	...
																	readonly="readonly"
																	onchange="calculateMonth('addForm')">&nbsp;&nbsp;
			...
			<div class="loan_out" id="det"></div>
															...
															<tr align="center" valign="middle">
																...
																<td colspan="6"><input type="button" class="myButton"
																	...
																	type="button"  class="myButton" value="Cancel" onClick="addnewcancel()" /></td>
															</tr>
														</table>
