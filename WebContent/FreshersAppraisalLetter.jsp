...
<div id="content" style="background-color: lightgray; ">
	...
	<div id="content" align="center"  ><!--  start page-heading -->
			<div id="step-holder" align="center">
				...
				<div class="step-no"><a href="FreshersAppraisalLetter.jsp" style="color: white;">5</a></div>
				<div class="step-dark-left"><a href="FreshersAppraisalLetter.jsp">Interview Appraisal Report</a></div>
