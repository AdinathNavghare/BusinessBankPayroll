...
<!-- <script type="text/javascript">
 ...
 function vali()
 {
	debugger;
	 ...
	 var b=document.getElementById("subtask").value;
	 //alert(b);
	 var a=document.getElementById("othrst").value;
	 alert(a);
	
	 var letters = /^[A-Za-z _ . ! " ' ]*$/;  
	  //var letters = /^[A-Za-z _ . , ! " ' ]*$/;                                    add punctuation
	 
	   if(othrst.value.match(letters))
	     {
		   //alert("right");
	      return true;
	     }
	     ...
	     {
	     alert("please enter valid task number is not allow");
	     return false;
	     }
}
...
AddTaskDao adaAddTaskDao = new AddTaskDao();
	result1=adao.getSubTaskEditDetail(tid);

	  for(AddTaskBean rs2 : result1)
	  {	
...
<!-- 	<div id="Task" class="tabcontent nav-link active" data-toggle="tab">
	...
	<form action="AddTaskServlet?action=editsubtask" method="post" onsubmit="return vali()">
...
%>
			...
			<tr class="alt"><td>Project Name :</td>
				<td colspan="3"><input type="text" id="pnm" name="pnm" value="<%=project%>" class="form-control" class="form control" disabled="true"  style="width:600px; height: 30px";></td>
			</tr>
			<tr class="alt">   
               <td >Task Name :</td>
				<td colspan="3"><input type="text" id="name" name="name" value="<%=name%>" class="form-control" class="form-control" disabled="true"  style="width:600px; height: 30px";></td>
			   
			</tr>

           <tr class="alt"><td>Type :</td>
				<td>
					<input type="text" id="typeid" name="type" value="<%=type%>" disabled="true" class="form-control" style="width:195px";>
				</td>
          
            <td style="min-width:160px"> Status :</td>
				<td>
                   <input type="text" id="status" name="status" value="<%=status%>" class="form-control" disabled="true">
          ...
          <tr class="alt"><td>Priority :</td>
				<td>
				      <input type="text" id="priority" name="priority" value="<%=priority%>" class="form-control" disabled="true" style="width:195px";>
			 ...
			 <tr class="alt"><td>Start Date :</td>
			    			<td><input type='text' class='datepick' id='startdate'  value="<%=taskstartdt %>" name="startdate" disabled="true" style="width:160px; height: 30px";></td>
							
							<td>Due Date :</td>
							<td><input type="text" name="duedate" class='datepick' id="duedate"  value="<%=duedt %>" placeholder="Enter Date" disabled="true" style="width:160px; height: 30px";></td>
			  ...
			  <tr class="alt"><td>Sub Task :</td>
							<td colspan="3">
							<div class="dropdown">
								    <input name="othrst" id="othrst" type="text" />
								    <select name="subtask" id="subtask" onchange="this.previousElementSibling.value=this.value; this.previousElementSibling.focus()">
							...
							<%                
											 ...
											 try
											 {
											 String str1="select * from SubTask where TASK_ID='"+tid+"'";
											 ...
											 while(rss.next())
											 {
												...
												%>	
						     					 ...
						     					 <option value="<%=rss.getInt("Sub_ID") %>,<%=rss.getString("SubTName")== "" ? null : rss.getString("SubTName") %>"><%=rss.getString("SubTName") %></option> 
							...
							<tr align="center">
							<td  colspan="4">
			              <input type="submit" value="UpdateSubTask" name="Save" class="myButton" >&nbsp;&nbsp;
